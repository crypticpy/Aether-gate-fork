...
from .talkermemory import (  # noqa: F401 (re-exported: this module used to hold them)
    MEMORY_MATCH, MEMORY_MAX, MEMORY_MERGE, TalkerMemory,
)
...
# MEMORY_MATCH, MEMORY_MAX, MEMORY_MERGE and TalkerMemory itself now live in
# talkermemory.py (imported above) and are re-exported here for anyone still
...
# MEMORY_MAX slots fills with syllable-long fits of one talker otherwise. An
